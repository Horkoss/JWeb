            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="images/find_user.png" class="user-image img-responsive"/>
                      ...
                      <li  >
                        <a  href="table.html"><i class="fa fa-users fa-3x"></i> User Management</a>
                    </li>
                    <li  >
                        <a href="form.html"><i class="fa fa-edit fa-3x"></i> News </a>
                    </li>				
                   <li  >
                        <a  class="active-menu"  href="form.html"><i class="fa fa-newspaper-o fa-3x"></i> Newsletters</a>
                    </li>
                </ul>
